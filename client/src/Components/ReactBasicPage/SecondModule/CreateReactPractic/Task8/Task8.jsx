                ...
                <div style={{ display: 'flex', flexGrow: 1 }}>
                    ...
                    <h1>Функциональные и классовые компоненты</h1>
                        ...
                        <ul style={{listStyle: 'none', paddingLeft: '0px'}}>
                            <li>
                                {!droppedItem && <DragItem id="1" name="a) Компоненты, которые создаются с помощью ES6 классов." type="TYPE_B" />}
                            </li>
                            <li>
                                {!droppedItem && <DragItem id="2" name="b) Компоненты, которые создаются с помощью JavaScript функций." type="TYPE_A" />}
                            </li>
                            <li>
                                {!droppedItem && <DragItem id="3" name="c) Компоненты, которые используются только для работы с состоянием." type="TYPE_B" />}
                            </li>
                            <li>
                                {!droppedItem && <DragItem id="2" name="d) Компоненты, которые создаются с помощью HTML и CSS." type="TYPE_B" />}
                            </li>
                        </ul>
