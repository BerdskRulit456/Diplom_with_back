                ...
                <div style={{ display: 'flex', flexGrow: 1 }}>
                    ...
                    <div style={{ marginLeft: isMobile ? 0 : 240, padding: 20, flexGrow: 1 }}>
                        ...
                        <div className="question">
                            Какие команды необходимо выполнить для создания нового проекта React?
                        </div>
                        <ul style={{listStyle: 'none', paddingLeft: '0px'}}>
                            <li>
                                {!droppedItem && <DragItem id="1" name="a) node -v и npm -v" type="TYPE_B" />}
                            </li>
                            <li>
                                {!droppedItem && <DragItem id="2" name="b) npx create-react-app my-first-react-app" type="TYPE_A" />}
                            </li>
                            <li>
                                {!droppedItem && <DragItem id="3" name="c) npm start" type="TYPE_B" />}
                            </li>
                        </ul> 
