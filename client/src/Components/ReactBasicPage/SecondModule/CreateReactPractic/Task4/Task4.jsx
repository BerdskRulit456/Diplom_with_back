                    ...
                    <div style={{ marginLeft: isMobile ? 0 : 240, padding: 20, flexGrow: 1 }}>
                        ...
                        <div style={{ padding: '20px'}}>
                            <div className="question">
                                Какой шаг необходим для начала работы с React
                            </div>
                            <ul style={{listStyle: 'none', paddingLeft: '0px'}}>
                                <li>
                                    {!droppedItem && <DragItem id="1" name="a) Установка Node.js и npm" type="TYPE_A" />}
                                </li>
                                <li>
                                    {!droppedItem && <DragItem id="2" name="b) Установка Visual Studio Code" type="TYPE_B" />}
                                </li>
                                <li>
                                    {!droppedItem && <DragItem id="3" name="c) Установка Java Development Kit" type="TYPE_B" />}
                                </li>
                            </ul>
