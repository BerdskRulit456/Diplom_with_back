                ...
                <div style={{ display: 'flex', flexGrow: 1 }}>
                    ...
                    <h1>Функциональные и классовые компоненты</h1>
                        ...
                        <ul style={{listStyle: 'none', paddingLeft: '0px'}}>
                            <li>
                                {!droppedItem && <DragItem id="1" name="a) Так же, как и классовые компоненты, передавая им методы жизненного цикла." type="TYPE_B" />}
                            </li>
                            <li>
                                {!droppedItem && <DragItem id="2" name="b) Так же, как и объекты, передавая им методы." type="TYPE_B" />}
                            </li>
                            <li>
                                {!droppedItem && <DragItem id="3" name="c) Так же, как и HTML-теги, передавая им пропсы." type="TYPE_A" />}
                            </li>
                            <li>
                                {!droppedItem && <DragItem id="2" name="d) Так же, как и модули, импортируя их в другие файлы." type="TYPE_B" />}
                            </li>
                        </ul>
